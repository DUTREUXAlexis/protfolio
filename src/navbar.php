<div class="leftscreen d-flex" style="width: 13.5%; margin-right: 10%; z-index: 1000">
    ...
    <ul class="d-flex row mt-3" style="margin:0; padding:0; margin-right: 7.5%">
        ...
        <li class="col mb-3 list-unstyled"><a class="btn button col text-light border border-light" href="#PROJETS"><i class="bi bi-cpu"></i> Projets</a></li>
